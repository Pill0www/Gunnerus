...
df_power_eng1 = df[df['sensor'].str.contains('port_mp/LoadFeedback')][['timestamp', 'value']]
df_power_eng1.rename(columns={'value': 'power_eng1'}, inplace=True)

df_power_eng2 = df[df['sensor'].str.contains('stbd_mp/LoadFeedback')][['timestamp', 'value']]
